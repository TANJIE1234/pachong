...
//            }
    ...
    public static void main(String[] args){
        try{
            ...
            bw = new BufferedWriter(new FileWriter("/home/tanjie/java/IdeaProjects/pachong/src/main/data/json",true));
            for(int i=1;i<totalAnnouncement/30+2;i++){
//                downloadFile("http://www.cninfo.com.cn/cninfo-new/disclosure/sse",i);
